...
public class RR {
	...
	// Method to find the waiting time for all 
		...
		// Method to calculate average waiting time 
				static float minfindavgwTime(int processes[], int n, int bt[],int quantum) 
				{ 
					int wt[] = new int[n], tat[] = new int[n]; 
					int total_wt = 0, total_tat = 0; 
				...
				static float minfindavgtTime(int processes[], int n, int bt[],int quantum) 
				{ 
					int wt[] = new int[n], tat[] = new int[n]; 
					int total_wt = 0, total_tat = 0; 
					...
					System.out.println("Average turn around time of RR = " + 
							(float)total_tat / (float)n);
